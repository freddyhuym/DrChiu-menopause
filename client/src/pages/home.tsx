...
// Image Assets
const HERO_IMAGE = "/attached_assets/chiu_portrait_full.jpg";
const ABOUT_IMAGE = "/attached_assets/chiu_portrait_full.jpg";
const PROCESS_IMAGE = "/attached_assets/chiu_portrait_full.jpg";
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-full min-h-[400px] rounded-2xl overflow-hidden shadow-2xl">
              <img 
                src="/attached_assets/chiu_portrait_full.jpg" 
                alt="專業諮詢" 
                className="w-full h-full object-cover"
              />
